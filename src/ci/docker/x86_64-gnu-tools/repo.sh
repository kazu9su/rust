...
#       * Encrypt the token:
#           ```
#           travis -r rust-lang/rust encrypt TOOLSTATE_REPO_ACCESS_TOKEN=aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
#           ```
...
commit_toolstate_change() {
    ...
    printf 'https://%s:x-oauth-basic@github.com\n' "$TOOLSTATE_REPO_ACCESS_TOKEN" > "$HOME/.git-credentials"
    git clone --depth=1 https://github.com/kennytm/rust-toolstate.git
